...
<div class="form-container">
    <form action="afterupdatepolicyholder" method="POST">

        <h2 class="admin-message">Update Policy Holder</h2>

        <label for="id">Policy Number:</label>
        <input type="text"  name="id" placeholder="Enter Policy Number" required>

        <label>Mobile No</label>
        
        <label for="contact">Enter New Contact No:</label>
        <input type="text" name="contact" placeholder="Enter New Contact" required>

        <button type="submit">Update Policy Holder</button>
        <!-- Use a button type instead of href for the form submission -->
    </form>
</div>
