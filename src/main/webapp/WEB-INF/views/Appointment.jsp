...
<nav>
		...
		<ul>
			<li><a href="Holder">Home</a></li>
			<li><a href="Policy">Policy</a></li>
			<li><a href="Appointment">Book Appointment</a></li>
		    <li><a href="StatusAll">Appointment Status</a></li>
...
<div class="form-container">
    <form action="viewAppointmentsubmit" method="POST">
         <div class="admin-message">Book Appointment</div>
        ...
        <input type="text" name="contact" placeholder="Mob no" required>
