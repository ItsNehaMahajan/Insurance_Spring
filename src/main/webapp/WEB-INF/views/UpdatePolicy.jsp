...
<div class="form-container">
    <form action="afterupdatepolicy" method="POST">

        <h2 class="admin-message">Update Policy Due Date</h2>
        ...
        <input type="text" name="dueDate" placeholder="Due Date" required>

        <button type="submit">Update Policy Due Date</button>
