...
<body class="sub_page">
 ...
 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="agentLogin">Agent</a>
    <a class="dropdown-item" href="PolicyHolderLogin">Customer</a>
  </div>
</div>
...
<a href="#">
  ...
  <!-- popper js -->
  <script src="./resources/https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js" integrity="sha384-Q6E9RHvbIyZFJoft+2mJbHaEWldlvI9IOYy5n3zV9zzTtmI3UksdQRVvoxMfooAo" crossorigin="anonymous"></script>
  <!-- bootstrap js -->
  <script src="./resources/js/bootstrap.js"></script>
  <!-- custom js -->
  <script src="./resources/js/custom.js"></script>
  <!-- Google Map -->
  <script src="./resources/https://maps.googleapis.com/maps/api/js?key=AIzaSyCh39n5U-4IoWpsVGUHWdqB6puEkhRLdmI&callback=myMap"></script>
  <!-- End Google Map -->
</body>
