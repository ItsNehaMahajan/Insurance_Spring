...
<%@page import="insuranceModel.Appointment"%>
...
<body>
	...
	<div class="table-container">
		<table class="table">
			...
			<label><h1><center>Policy Holder Appointment</center></h1></label>
				<tr>
...
<tr>
	...
	<td><%=Ap.getContact() %></td>
	<td><%=Ap.getAddress() %></td>
	<td><a href="<%= request.getContextPath() %>/approve/<%=Ap.getContact()%>">Approved</a></td>

  <td><a href="<%= request.getContextPath() %>/disapprove/<%=Ap.getContact()%>">Disapproved</a></td>
