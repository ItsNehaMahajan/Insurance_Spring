...
<div class="form-container">
    <form action="afteraddpolicy" method="POST">
         <div class="admin-message">Policy </div>
        
       <label for="id"> Enter Policy Number</label>
        ...
        <label for="policyTitle"> Enter Policy Title</label>
        <input type="text" name="policyTitle" placeholder="policyTitle" required>
        
        <label for="details"> Enter Policy Details</label>
        <input type="text" name="details" placeholder="details" required>
      <label for="dueDate">Expiry Date</label>
<input type="text" name="dueDate" id="dueDate" placeholder="yyyy-mm-dd" required>
...
<script>
  ...
  $(document).ready(function() {
    ...
    const options = {
      ...
      minDate: new Date(), // Optionally set the minimum date (e.g., today)
      maxDate: new Date(2100, 11, 31), // Optionally set the maximum date
    };
    dueDateInput.datepicker(options);
  });
</script>
